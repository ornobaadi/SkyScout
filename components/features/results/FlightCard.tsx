...
import { ChevronDown, Plane, Clock, Circle } from "lucide-react";
                                        ...
                                        <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm rounded-xl p-4 border border-slate-200/50 dark:border-slate-700/50">
                                            ...
                                            <div className="grid grid-cols-2 gap-4 text-sm">
                                                <div>
                                                    ...
                                                    <div className="font-medium text-slate-900 dark:text-white">{format(new Date(segment.departure.at), 'HH:mm, MMM d')}</div>
                                                </div>
                                                <div>
                                                    <div className="text-slate-500 dark:text-slate-400 text-xs mb-1">Arrive</div>
                                                    <div className="font-medium text-slate-900 dark:text-white">{format(new Date(segment.arrival.at), 'HH:mm, MMM d')}</div>
                                                </div>
                                            </div>
